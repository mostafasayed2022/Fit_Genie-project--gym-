...
const Fitness: React.FC = () => {
    const data = SERVICE_DETAILS.fitness;
        ...
        <div className="pt-20 bg-dark text-white overflow-x-hidden">
            ...
            <div className="container mx-auto px-6 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                <div data-aos="fade-right">
                    <span className="text-primary font-black uppercase tracking-[0.4em] text-[10px] mb-4 block">Evolve your body</span>
                    <h2 className="text-3xl md:text-5xl mb-8 leading-[0.95] font-black uppercase tracking-tighter italic">
                        WHAT IS <span className="text-primary italic font-['Outfit']">FITNESS?</span>
                    </h2>
                    <p className="text-white/60 text-base md:text-lg leading-relaxed mb-10 max-w-xl italic">
                        {data.intro}
                    </p>
                ...
                <div className="relative rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl border border-white/5 group" data-aos="fade-left">
                    <img src={data.gif} alt="fitness" className="w-full h-full object-cover aspect-video group-hover:scale-105 transition-transform duration-1000" />
            ...
            <section className="py-20 lg:py-32 bg-dark-lighter">
                <div className="container mx-auto px-6 text-center mb-16 px-4">
                    <span className="text-primary font-black uppercase tracking-[0.4em] text-[10px]">Why choose us</span>
                    <h2 className="text-3xl md:text-6xl uppercase tracking-tighter font-black italic mt-4">Fitness <span className="text-primary">Advantages</span></h2>
                </div>
                ...
                <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10">
                    {data.advantages.map((adv, index) => (
                        <div 
                            key={index} 
                            className="glass-card group hover:border-primary/20 transition-all duration-700 hover:-translate-y-2 border border-white/5"
                            data-aos="fade-up"
                        ...
                        >
                            ...
                            <h3 className="text-xl md:text-2xl font-black mb-4 uppercase tracking-tighter italic">{adv.title}</h3>
            ...
            <section className="py-20 lg:py-32 bg-dark relative overflow-hidden">
                <div className="container mx-auto px-6 text-center mb-16 px-4">
                    <span className="text-primary font-black uppercase tracking-[0.4em] text-[10px]">Visual Journey</span>
                    <h2 className="text-3xl md:text-6xl uppercase tracking-tighter font-black italic mt-4 px-4">Fitness <span className="text-primary">Gallery</span></h2>
                </div>
